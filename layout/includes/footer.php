...
function socialmedia() {
    ...
    for ($sm = 1; $sm <= $numofsocialmedia; $sm++) {
        $status = theme_academi_get_setting('socialmedia'.$sm.'_status') ? : 0;
        $icon = theme_academi_get_setting('socialmedia'.$sm.'_icon');
        if(empty($icon)) {
            $icon = get_string('socialmediaicon'.$sm.'_default', 'theme_academi');
        }
        $url = theme_academi_get_setting('socialmedia'.$sm.'_url');
        if(empty($url)){
            $url = get_string('socialmediaurl'.$sm.'_default', 'theme_academi');
        }
        $iconcolor = theme_academi_get_setting('socialmedia'.$sm.'_iconcolor');
        if(empty($iconcolor)) {
            $iconcolor = get_string('socialmediaiconcolor'.$sm.'_default', 'theme_academi');
        }
        $socialmedia[] = [
            'socialstatus' => $status,
            'sicon' => $icon,
