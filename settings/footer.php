...
$description = get_string('copyright_footer_desc', 'theme_academi');
...
$default = get_string('footerbtitle1default', 'theme_academi');
$setting = new admin_setting_configtext($name, $title, $description, $default);
$temp->add($setting);
...
$title = get_string('title', 'theme_academi');
$description = get_string('footerbtitledesc', 'theme_academi');
$default = get_string('footerbtitle2default','theme_academi');
$setting = new admin_setting_configtext($name, $title, $description, $default);
$temp->add($setting);
...
$title = get_string('title', 'theme_academi');
$description = get_string('footerbtitledesc', 'theme_academi');
$default = get_string('footerbtitle3default', 'theme_academi');
$setting = new admin_setting_configtext($name, $title, $description, $default);
$temp->add($setting);
...
$title = get_string('title', 'theme_academi');
$description = get_string('footerbtitledesc', 'theme_academi');
$default = get_string('footerbtitle4default', 'theme_academi');
$setting = new admin_setting_configtext($name, $title, $description, $default);
$temp->add($setting);
...
for ($f = 1; $f <= $numofsocialmedia; $f++) {
    ...
    $name = 'theme_academi_socialmedia'.$f;
    $heading = get_string('socialmedia', 'theme_academi', ['socialmedia' => $f]);
    $information = '';
    $setting = new admin_setting_heading($name, $heading, $information);
    $temp->add($setting);
